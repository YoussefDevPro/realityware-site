  ...
  return (
    <>
      ...
      <div className="fixed -top-1 right-0 z-50 max-width max-w-xs px-4 mt-8 text-center">
        <a href="http://localhost:8080/login/slack/" className="inline-block px-6 py-3 bg-black text-white rounded-lg shadow hover:opacity-90 transition">
          Sign in with Slack!
        </a>
      </div> 
      <div className="min-h-screen items-center justify-center">
        <header className="bg-background w-full mx-auto min-h-[20vh] pt-[18vh] pb-[12vw]" id="home">
          {showTitle && (
            <div className="fixed top-0 left-0 w-full z-2 bg-background/80 backdrop-blur shadow text-left py-2 items-center flex">
              ...
              <div className="z-50 max-width max-w-xs px-[2vw]">
                <img src="/static/hackclublogo.png" alt="Hack Club logo" width={181} height={63} className="object-contain w-[calc(6vw+10vh)] h-auto" />
              </div>
          ...
          <div className="absolute top-0 left-[38vw] z-50 max-width max-w-xs px-[4vw]">
            <img src="/static/flag-orpheus-top.png" alt="Hack Club logo" width={181} height={63} className="object-contain w-[calc(8vw+15vh)] h-auto" />
          </div>
